...
const imageryOptionsEnable = () => {
    console.log(typeof imageryOptions)
    console.log(imageryOptions.length)
    for (let i = 0; i<imageryOptions.length-1; i++) {
        imageryOptions[i].removeAttribute('disabled')
    }
    // imageryOptions.forEach((item) => item.removeAttribute('disabled'))
}

const imageryOptionsDisable = () => {
    for (let i = 0; i<imageryOptions.length-1; i++) {
        imageryOptions[i].setAttribute('disabled','')
    }
    // imageryOptions.forEach((item) => item.setAttribute('disabled', ''))
}
